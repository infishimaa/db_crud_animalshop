...
CREATE TABLE orders (
  ...
  CONSTRAINT orders_ibfk_2 FOREIGN KEY (animal_id) REFERENCES animals (id)
    ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(3, 'Пришва Олександра Михайлівна', 'oleksandra.mykhailivna@gmail.com', 'Розвідник'),
(4, 'Скоробагатько Леся Олексіївна', 'lesia.skorobahatko@gmail.com', 'Розвідник'),
...
(15, 'Фесюн Наталія Степанівна', 'natfes@ukr.net', 'Розвідник');
